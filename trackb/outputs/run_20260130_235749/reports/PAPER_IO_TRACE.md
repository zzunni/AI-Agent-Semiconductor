...
| validation/lot_leakage_diagnostics.json | — | n_test_wafers, n_test_lots, overlap_lots_count, overlap_wafers_count, high_risk_rate_by_lot_* | Limitations·Lot leakage 리스크 진단 표(무재학습) |
| validation/random_seed_sweep_summary.json | — | recall_mean, recall_std, recall_p5, recall_p50, recall_p95 | Random multi-seed recall 분포·Framework 위치 |
