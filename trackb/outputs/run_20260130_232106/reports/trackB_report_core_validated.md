...
생성 시각: 2026-01-30 23:47:28

본 보고서의 모든 수치·표·결론은 이 실행(run_20260130_232106)의 산출물만 사용합니다. 다른 run 또는 외부 데이터를 사용하지 않습니다.
...
| n_train_lots | 50 |
| overlap_lots_count (train ∩ test) | 49 |
| overlap_wafers_count (test 중 overlap lot 소속) | 200 |
