...
생성 시각: 2026-01-30 23:58:29

본 보고서의 모든 수치·표·결론은 이 실행(run_20260130_235828)의 산출물만 사용합니다. 다른 run 또는 외부 데이터를 사용하지 않습니다.
...
- **Lot leakage 진단**: lot_id 또는 메타데이터 없음으로 표 생성 불가; 리스크는 동일 조건 내 해석으로 한정.
